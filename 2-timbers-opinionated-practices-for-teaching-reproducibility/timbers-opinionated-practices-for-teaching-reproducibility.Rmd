...
<img src="img/ostblom-timbers-2022.png" alt="Screenshot of Ostblom and Timbers 2022 JSDSE paper" height=475>
...
.pull-right[
<img src="img/tourists-go-up-hill-sunrise.jpg" alt="A person helping other person climb a steep hill" width=450>
...
<img src="img/bonus-gift.png" alt="Cartoon of a bonus gift" height=350>
...
<img src="img/covid-forcast.png" "Visualization of a model that predicts future COVID cases" height=350>
...
<img src="img/shark-wave.png" alt="Man waving and smiling not knowing a shark is behind him" height=350>
...
<img src="img/git_2x.png" alt="infamous xkcd comic about how no one knows how to use Git" height=350>
...
.pull-right[
<img src="https://media.giphy.com/media/3240pzelRQkjj9XaiK/source.gif" alt="Kylo Ren from Star Wars the Force Awakens saying I know what I have to do but I don't know if I have the strength to do it">
...
1. <font color="#B30059">placing extra emphasis on motivation</font>

2. guided instruction

3. <font color="#B30059">lots of practice!!!</font>
...
3. <font color="#B30059">Tell stories from the trenches</font>
...
- *Reproducibility failure > computational environment*
...
.pull-left[
<img src="img/repro_theme_chart.png" alt="bar graph showing that version control, code, documentation, and environments are the most common causes of reproducibility failures" width=500>
]

.pull-right[
<img src="img/cost_theme_chart.png" alt="bar graph showing that time is the most common cost of reproducibility failures" width=500>
]
...
.pull-right[
<img src="img/mds-students.jpeg" alt="a photograph of data science students working in a UBC MDS classroom" width=350>
...
3. <font color="#B30059">Pre-bake exercises</font>

---

### Pre-bake exercises

Some reproducibility tasks require time consuming, 
or complex, prerequisite work before it makes sense to do them.
...
.pull-left[
<img src="img/martha-stewart.png" alt="Photo of Martha Stewart baking show" width=500>
...
.pull-left[
Reviewing pull requests is a task where it is difficult to get a lot of practice! 
...
.pull-right[
 <img src="img/inclined-wooden-block-tower-jenga-game-with-hand-risk-concept.jpg" alt="Jenga tower falling over" height=350>
...
<img src="img/review-my-pr-repo.png" alt="Screenshot of review-my-pull-request GitHub repository" height=450>
...
<img src="img/review-my-pr-demo.png" alt="Screenshot of pull request automatically generated by GitHub actions for students to practice pull request reviews" height=450>
...
.pull-right[
<img src="img/mds-students2.jpeg" alt="a photograph of data science students working in a UBC MDS classroom" width=400>
...
#### <font color="#B30059">1. Extra emphasis on motivation</font>

#### 2. Guided instruction

#### <font color="#B30059">3. Lots of practice!!!</font>

---

class: center, middle

<img src="https://media.giphy.com/media/x1yhRwlqxBiQU/source.gif" alt="Gif of the Dude from the Big Lewbowsk saying yeah, well, that's just like your opinion man" width=800>
...
<img src="https://ubc-mds.github.io/img/team/group.jpeg" alt="Group photo of UBC MDS teaching team">
]
---
...
#### JSDSE paper: https://www.tandfonline.com/doi/pdf/10.1080/26939169.2022.2074922
